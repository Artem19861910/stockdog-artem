...
angular.module('stockDogApp')
  .service('WatchlistService', function WatchlistService() {
    ...
    // added after p.29 of book.
    // Augment Stock with additional helper functions
    var StockModel = {
      save: function () {
    ...
    // [1] Helper: Load watchlists from localStorage. Modified after p.30
...
parseInt(localStorage['StockDog.nextId']) : 0
    ...
    // [5] Save a new watchlist to watchlists model. Modified after p.30
